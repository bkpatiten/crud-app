                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <img src="{{asset('/uploads/products/default_product_image.jpg')}}" id="product_thumbnail" class="img-thumbnail rounded" alt="Product Image">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                {{ Form::textarea('description',NULL,['class' => 'form-control'.($errors->first('description') ? ' is-invalid' : '')]) }}
